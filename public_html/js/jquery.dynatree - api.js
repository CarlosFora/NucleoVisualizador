...
//              this.tree.logDebug("nodeTitle: " + nodeTitle);
		...
		if ( data.icon ) {
			...
			res += "<span id='"+ data.key +"_wms_option_buttons'class='wms-options-buttons ' style='visibility: hidden; margin-left: 25px;'>" +
					"<span title='" + i18n.t("Mover elemento hacia arriba") + "' class='wms-options-button option-up-disabled-button '></span>" +
					"<span title='" + i18n.t("Mover elemento hacia abajo") + "' class='wms-options-button option-down-disabled-button'></span>" +
					"<span title='" + i18n.t("Borrar elemento") + "' class='wms-options-button option-remove-button'></span>";
//			if (data.featureInfo){
//				res += "<span title='" + i18n.t("Mostrar informacion") + "' class='wms-options-button option-info-button'></span>";
//			}
			res += "</span>";
		} 
		//end
